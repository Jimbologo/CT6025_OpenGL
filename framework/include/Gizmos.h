...
public:
	...
	// Adds a Cone aligned to the Y-axis with optional transform for rotation.
	static void		addCone(const glm::vec3& a_center, float a_radius, float a_endRadius,
		float a_fHalfLength, unsigned int a_segments,
		const bool& a_filled, const glm::vec4& a_fillColour = glm::vec4(1.f, 1.f, 1.f, 1.f),
		const glm::mat4& a_transform = glm::mat4(1.f, 0.f, 0.f, 0.f, 0.f, 1.f, 0.f, 0.f, 0.f, 0.f, 1.f, 0.f, 0.f, 0.f, 0.f, 1.f),
		glm::vec3** vertexData = nullptr, unsigned int* a_vertexCount = nullptr);
	...
	static void		addSphere(const glm::vec3& a_center, int a_rows, int a_columns, float a_radius, const glm::vec4& a_fillColour, const bool& a_filled,
