...
bool TessellationShaderApplication::onCreate()
{
	...
	//load in our Texture
	LoadImageFromFile("./resources/images/burnedWood/burned wood_COLOR.jpg", m_DiffuseTex);
	LoadImageFromFile("./resources/images/burnedWood/burned wood_NRM.jpg", m_NormalTex);
	LoadImageFromFile("./resources/images/burnedWood/burned wood_SPEC.jpg", m_SpecularTex);
	LoadImageFromFile("./resources/images/burnedWood/burned wood_DISP.jpg", m_DisplacementTex);
	LoadImageFromFile("./resources/images/burnedWood/burned wood_OCC.jpg", m_OcclusionTex);
