...
bool Reflection::onCreate()
{
	...
	//\==========================================================================================
	//Load the shaders for this program
	m_vertexShader = Utility::loadShader("./resources/shaders/fs_vertex.glsl", GL_VERTEX_SHADER);
	m_fragmentShader = Utility::loadShader("./resources/shaders/fs_fragment.glsl", GL_FRAGMENT_SHADER);
	//Define the input and output varialbes in the shaders
	//Note: these names are taken from the glsl files -- added in inputs for UV coordinates
	...
	glBindFramebuffer(GL_FRAMEBUFFER, m_fbo_depth_texture);
